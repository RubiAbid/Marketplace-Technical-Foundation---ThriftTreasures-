        ...
        {products.slice(0, 12).map((product) => (
          ...
          >
            <div className="relative w-full h-64 mb-4">
              {/* Product image now wraps in a Link */}
  ...
  />
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="bg-black text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-all duration-300"
              >
                Add to Cart
              </button>
            </div>
      ...
      {isPopupVisible && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg max-w-xs text-center">
            <h3 className="text-lg font-semibold text-gray-800">Item added to cart!</h3>
          </div>
        </div>
      )}
    </div>
